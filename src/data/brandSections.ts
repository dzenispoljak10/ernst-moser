  ...
  'pudu-robotics': [
    {
      ...
      imageRight: false,
      features: [
        { icon: 'Bot', title: '40 kg Nutzlast', text: 'Bis zu 4 Tabletts gleichzeitig — BellaBot ersetzt bis zu 4 Lieferfahrten pro Stunde.' },
        { icon: 'Navigation', title: 'SLAM-Navigation', text: 'Autonome Navigation ohne externe Infrastruktur — BellaBot kartiert und navigiert selbstständig.' },
        { icon: 'Users', title: 'Weltweiter Standard', text: 'Über 75.000 Pudu-Roboter weltweit im Einsatz — meistverkaufter Service-Roboter der Welt.' },
      ],
    },
    {
      type: 'tech',
      ...
      specs: [
        ...
        { label: 'Nutzlast', value: 'bis 40 kg' },
        { label: 'Akkuautonomie', value: '24h Betrieb' },
        { label: 'Einsatzorte', value: 'Restaurant, Hotel, Pflege, Logistik' },
      ],
      features: [],
    },
  ],
