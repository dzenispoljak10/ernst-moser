...
export const metadata: Metadata = {
  title: 'Wohnmobile & Camper – Nutzfahrzeugcenter Ernst Moser',
  description:
    'Reparaturen, Service, Wartungen und MFK-Bereitstellung für Camper und Wohnmobile – Ernst Moser GmbH, Gerlafingen Solothurn.',
}
...
const ANFRAGE_MAILTO =
  ...
  encodeURIComponent('Anfrage Wohnmobile Camper')
    ...
    <>
      ...
      >
        <div style={{ position: 'absolute', inset: 0, zIndex: 0 }}>
          <Image
            src="/images/pages/wohnmobile-camper/hero-camper.webp"
            alt="Wohnmobil"
            fill
            priority
            sizes="100vw"
        ...
        >
          ...
          >
            ...
            <ChevronRight size={13} />
            <span style={{ color: '#fff' }}>Wohnmobile & Camper</span>
          </nav>
          ...
          >
            ...
            und Wohnmobile – kompetent und marken­übergreifend in
        ...
        <div className="container" style={{ maxWidth: 880 }}>
          <AnimatedSection>
            ...
            <h2 className="section-title" style={{ marginBottom: 24 }}>
              Camper oder Wohnmobil – wir sind Ihr Partner
            </h2>
            <p
              style={{
                fontSize: 16,
            ...
            >
              Ob Camper, Wohnmobil oder ausgebauter Kastenwagen –
      ...
      <section
        ...
        style={{
          background: '#fff',
          scrollMarginTop: 'calc(var(--header-h, 84px) + var(--topbar-h, 44px) + 20px)',
        }}
      >
        <div className="container" style={{ maxWidth: 980 }}>
          <AnimatedSection>
            <div className="section-divider" style={{ background: COLOR }} />
            <div className="section-label">Sicherheit & Prüfung</div>
            <h2 className="section-title" style={{ marginBottom: 24 }}>
          ...
          >
            <AnimatedSection delay={0.05}>
              <p style={{ fontSize: 16, lineHeight: 1.75, color: 'var(--c-text-2)', margin: '0 0 16px' }}>
                Die Gasanlage in Ihrem Wohnmobil oder Camper muss regelmässig auf
                Dichtheit und Sicherheit geprüft werden. Wir führen die Gasprüfung
                fachgerecht durch und stellen sicher, dass Ihre Anlage einwandfrei
                und vorschriftskonform funktioniert.
              </p>
              <p style={{ fontSize: 16, lineHeight: 1.75, color: 'var(--c-text-2)', margin: 0 }}>
                So sind Sie und Ihre Mitreisenden auf jeder Reise auf der sicheren
                Seite – ob beim Kochen, Heizen oder Kühlen.
              </p>
            </AnimatedSection>
            ...
            <AnimatedSection delay={0.1}>
              ...
              >
                ...
                <div style={{ fontSize: 15, color: 'rgba(255,255,255,0.85)', lineHeight: 1.6 }}>
                  Gasprüfung für Wohnmobile – wir erinnern Sie gerne und übernehmen
                  die fachgerechte Kontrolle.
                </div>
                <a
                  href={ANFRAGE_MAILTO}
                  style={{
                ...
                >
                  Gasprüfung anfragen <ArrowRight size={15} />
                </a>
              </div>
            </AnimatedSection>
          </div>
      ...
      >
        <div className="container" style={{ maxWidth: 760, textAlign: 'center' }}>
          <AnimatedSection>
            ...
            >
              Termin für Ihren Camper oder Ihr Wohnmobil
            </h2>
            <p
              style={{
                fontSize: 16,
