...
export default function EditBrandPage() {
  ...
  if (!brand)
    return (
      <div className="p-8 text-center text-gray-400 text-sm">Marke nicht gefunden.</div>
    )
    ...
    <div className="p-8 max-w-2xl mx-auto">
      <div className="flex items-center gap-3 mb-8">
        ...
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Marke bearbeiten</p>
        </div>
      </div>
      ...
      <div className="space-y-5">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6">
          <h3 className="text-sm font-semibold text-gray-700 mb-4">Logo</h3>
          <div className="flex items-center gap-4">
            {brand.logoUrl ? (
              <img
                src={brand.logoUrl}
                alt={brand.name}
                className="w-20 h-14 object-contain rounded border border-gray-100 bg-gray-50 p-2"
              />
            ) : (
              <div className="w-20 h-14 rounded border border-dashed border-gray-200 flex items-center justify-center">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-6 space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2.5 border border-gray-200 rounded-lg text-sm text-gray-900 focus:outline-none resize-none"
              onFocus={(e) => {
