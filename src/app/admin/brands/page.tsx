                      ...
                      <div className="flex items-center gap-3">
                        {b.logoUrl ? (
                          <img
                            src={b.logoUrl}
                            alt={b.name}
                            className="w-10 h-8 object-contain rounded-lg border border-gray-100 bg-gray-50 p-1"
                          />
                        ) : (
                          <div className="w-10 h-8 rounded-lg border border-gray-100 flex items-center justify-center bg-gray-50">
