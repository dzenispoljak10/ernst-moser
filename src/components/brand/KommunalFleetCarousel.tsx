...
import { KOMMUNAL_CAROUSEL_SLIDES } from '@/lib/kommunal-catalogs'
import { MOTORGERAETE_CAROUSEL_SLIDES } from '@/lib/motorgeraete-catalogs'
...
/**
 * Generisches Auto-Play-Karussell für Kommunalcenter-Brands.
 * Identisch zu ScaniaFleetCarousel, parametrisiert mit slides.
 */
export default function KommunalFleetCarousel({
  brandSlug,
  accent,
  eyebrow,
  heading,
  ...
  const slides =
    KOMMUNAL_CAROUSEL_SLIDES[brandSlug] ??
    MOTORGERAETE_CAROUSEL_SLIDES[brandSlug] ??
    []
    ...
    >
      <div className="isuzu-carousel-inner">
        ...
        >
          ...
          <button type="button" className="isuzu-carousel-arrow isuzu-carousel-arrow--prev" onClick={goPrev} aria-label="Vorheriges Modell">
            <ChevronLeft size={20} />
          </button>
          <button type="button" className="isuzu-carousel-arrow isuzu-carousel-arrow--next" onClick={goNext} aria-label="Nächstes Modell">
